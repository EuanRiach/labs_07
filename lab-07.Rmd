...
The data is negative skewed suggesting students rated courses higher than an evenly represented normal distribution.
...
There is a slight positive relationship between score and beauty average.
...
Score^ is 3.88 which suggests a minimum score regardless of average beauty score.
...
Upwards sloping implying positive correlation between beauty and score
...
An intercept of 3.88 implies a positive skew of scoring and that scoring is not purely based on beauty as if it was the line would pass through the origin.
...
A low r squared suggests little correlation between score and beauty.
